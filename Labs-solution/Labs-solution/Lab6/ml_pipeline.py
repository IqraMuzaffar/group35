...
def main(dataset_path: str, accuracy_threshold: float = 0.9, test_size: float = 0.2):
...
if __name__ == "__main__":
    ...
    test_size = 0.2
    main(dataset_path=dataset_path, accuracy_threshold=accuracy_threshold, test_size=test_size)